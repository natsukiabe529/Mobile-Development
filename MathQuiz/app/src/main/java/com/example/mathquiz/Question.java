...
public class Question {
    ...
    // array to store 4 answer choices
    private int [] answerArray;

    // index number for the answer in the answerArray
    private int answerPosition;

    // the max value of firstNumber or secondNumber
    private int upperLimit;

    // output string of the problem,  ex)  4 + 9 =
